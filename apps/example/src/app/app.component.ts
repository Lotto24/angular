  ...
  providers: [
    provideImports<AppImportsOrchestration>({
      footer0: importStandalone(
        () => import('@angular-import-orchestrator/examples/footer0')
      ),
      footer1: importStandalone(
        () => import('@angular-import-orchestrator/examples/footer1')
      ),
      footer2: importStandalone(
        () => import('@angular-import-orchestrator/examples/footer2')
      ),
    }),
  ],
})
