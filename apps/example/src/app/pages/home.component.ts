  ...
  providers: [
    provideImports<AppImportsOrchestration>({
      ...
      home0: importStandalone(
        () => import('@angular-import-orchestrator/examples/home0')
      ),

      // if it contains multiple components, select the standalone component you would like to load
      home1: importStandalone(() =>
        import('@angular-import-orchestrator/examples/home1').then(
          (c) => c.ExamplesHome1Component
        )
      ),

      home2: importStandalone(
        () => import('@angular-import-orchestrator/examples/home2')
      ),

      // or import an NgModule with the component referenced in bootstrap
      home3: importNgModuleBootstrap(
        () => import('@angular-import-orchestrator/examples/home3')
      ),
